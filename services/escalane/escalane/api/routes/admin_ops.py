...
from escalane.connectors.mock import get_mock_store
from escalane.db.models import AdminAuditEvent, Alarm
from escalane.settings import Settings

router = APIRouter()


# Show the latest redacted administrative mutations for operational review.
...
# Summarize application/dependency state without exposing credentials or endpoints.
...
# Render simulated deliveries only when the deployment explicitly enables simulation.
...
# Clear test-only delivery history behind session and CSRF validation.
