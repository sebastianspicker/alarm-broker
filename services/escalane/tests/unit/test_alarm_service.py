"""Tests for escalane.services.alarm_service."""
...
from escalane.core.errors import ConflictError, NotFoundError
from escalane.db.models import Alarm, AlarmEventOutbox, AlarmStatus
...
try:
    ...
    from tests.worker_task_helpers import load_alarm_notes, persist_alarm
except ModuleNotFoundError:
    from constants import ACK_FOUND_TOKEN, ACK_SOFT_DELETED_TOKEN
    from worker_task_helpers import load_alarm_notes, persist_alarm
