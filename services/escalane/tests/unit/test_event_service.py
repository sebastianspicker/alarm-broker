"""Tests for escalane.services.event_service: error branches."""
...
async def test_enqueue_alarm_acked_event_error():
    ...
    with patch(
        "escalane.services.event_service.EventPublisher.publish_alarm_acknowledged",
...
async def test_enqueue_alarm_created_event_error():
    ...
    with patch(
        "escalane.services.event_service.EventPublisher.publish_alarm_created",
        new_callable=AsyncMock,
...
async def test_enqueue_alarm_state_changed_event_error():
    ...
    with patch(
        "escalane.services.event_service.EventPublisher.publish_alarm_state_changed",
        new_callable=AsyncMock,
