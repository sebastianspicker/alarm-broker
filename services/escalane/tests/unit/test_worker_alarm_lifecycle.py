...
try:
    ...
    from tests.worker_task_helpers import make_alarm, make_ctx, open_app_client, persist_alarm
except ModuleNotFoundError:
    from constants import TEST_ADMIN_API_KEY
    from worker_task_helpers import make_alarm, make_ctx, open_app_client, persist_alarm
